...
namespace CRUDTests
{
    ...
    public class CountriesServiceTest
    {
        ...
        // When you supply proper country name, it should insert (add) the counrty to the existing list of countries
        [Fact]
        ...
        [Fact]
        // If we supply a valid country id, it should return the valid matching country details as CountryResponse object
